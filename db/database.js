...
async function initDatabase() {
    ...
    await query(`
        ...
        ('Кожаная куртка', 'Простая защита', 44177, 1, '[{"item_id": 44183, "quantity": 5}]', 1, 10, 'common'),
        ('Бинт', 'Бинт из ткани', 44166, 2, '[{"item_id": 44183, "quantity": 3}]', 1, 3, 'common'),
        -- Средние рецепты
        ('Пистолет', 'Травматический пистолет', 44173, 1, '[{"item_id": 44181, "quantity": 5}, {"item_id": 44184, "quantity": 2}]', 5, 30, 'uncommon'),
        ('Бронежилет', 'Военный бронежилет', 44178, 1, '[{"item_id": 44181, "quantity": 10}, {"item_id": 44183, "quantity": 5}]', 10, 45, 'rare'),
        ('Противогаз', 'Защита от радиации', 44179, 1, '[{"item_id": 44184, "quantity": 3}, {"item_id": 44177, "quantity": 2}]', 8, 20, 'uncommon'),
        ('Аптечка', 'Полная аптечка', 44167, 1, '[{"item_id": 44166, "quantity": 3}, {"item_id": 44182, "quantity": 2}]', 5, 15, 'uncommon'),
        -- Редкие рецепты
        ('Автомат', 'Автоматическое оружие', 44174, 1, '[{"item_id": 44173, "quantity": 1}, {"item_id": 44181, "quantity": 8}, {"item_id": 44184, "quantity": 3}]', 15, 60, 'rare'),
        ('Дробовик', 'Охотничий дробовик', 44175, 1, '[{"item_id": 44181, "quantity": 6}, {"item_id": 44177, "quantity": 2}]', 12, 45, 'rare'),
        ('Армейская каска', 'Защита головы', 44180, 1, '[{"item_id": 44181, "quantity": 4}, {"item_id": 44183, "quantity": 2}]', 8, 20, 'uncommon'),
        ('Антидот', 'Лекарство от инфекций', 44168, 1, '[{"item_id": 44182, "quantity": 3}, {"item_id": 44172, "quantity": 2}]', 10, 25, 'rare'),
        ('Антирадин', 'Препарат от радиации', 44169, 1, '[{"item_id": 44182, "quantity": 5}, {"item_id": 44179, "quantity": 1}]', 15, 30, 'rare'),
        -- Эпические рецепты
        ('Снайперка', 'Снайперская винтовка', 44176, 1, '[{"item_id": 44181, "quantity": 15}, {"item_id": 44184, "quantity": 5}, {"item_id": 44172, "quantity": 3}]', 25, 120, 'epic'),
        -- Патроны
        ('Патроны', 'Патроны для оружия', 44188, 10, '[{"item_id": 44181, "quantity": 2}]', 3, 10, 'uncommon')
